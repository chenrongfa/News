...
public class FinancePagerFragment extends BaseFragment {
	...
	class StringResult extends StringCallback {
		...
		public void onError(Call call, Exception e, int i) {
			...
			String result = CacheUtils.getInstance().get(Constants.FINANCE_URL_CACHE, "");
		...
		public void onResponse(String s, int i) {
			...
			//缓存
			CacheUtils.getInstance().save(Constants.FINANCE_URL_CACHE,s);
	...
	private static final String TAG = "FinancePagerFragment";
}
