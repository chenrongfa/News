...
import chen.yy.com.news.pager.NewsImagesPagerFragment;
import chen.yy.com.news.pager.NewsVotePagerFragment;
...
public class NewsFrament extends BaseFragment {
	...
	private NewsCommunityPagerFragment newsCommunityFragmnet;
	...
	public void bindData() {
		...
		RequestParams url = new RequestParams(Constans.NEWSCENTER_PAGER_URL);
