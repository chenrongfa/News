...
public class SlowLivePagerFragment extends BaseFragment {
	private static final String TAG = "SlowLivePagerFragment";
	...
	class StringResult extends StringCallback {
		...
		public void onError(Call call, Exception e, int i) {
			...
			String result = CacheUtils.getInstance().get(Constants.SLOWLIVE_URLCACH, "");
		...
		public void onResponse(String s, int i) {
			...
			//缓存
			CacheUtils.getInstance().save(Constants.SLOWLIVE_URLCACH,s);
