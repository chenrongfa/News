...
import chen.yy.com.news.news.adapter.NewAdapter;
import chen.yy.com.news.news.bean.NewBean;
...
public class HotDiscuss extends BaseFragment {
      ...
      public void bindData() {
            super.bindData();
            getInternetData(Constants.HOT_POST_URL);
      }
