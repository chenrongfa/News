...
public class CullingTestAdapter extends CommonAdapter <CullingTest.IdlistBean.NewslistBean>{
	private List<CullingTest.IdlistBean.NewslistBean> newslistBeen;
	private Context mContext;
	public CullingTestAdapter(Context context, List<CullingTest.IdlistBean.NewslistBean> list, int layoutID) {
	...
	@Override
	public void bindData(CommonViewHolder viewHolder, CullingTest.IdlistBean.NewslistBean  bean, int position) {
		...
		CullingTest.IdlistBean.NewslistBean.LiveInfoBean live_info = bean.getLive_info();
		//存在
		if(live_info!=null) {
...
//		resolveSerie(bean, tv_serie, tv_serie_num, ll_serie_live);
	...
	private void resolveBottom(CullingTest.IdlistBean.NewslistBean bean, TextView tv_sources, TextView tv_time, LinearLayout ll_bottom) {
		int num=0;
...
//	private void resolveSerie(CullingTest.IdlistBean.NewslistBean bean, TextView tv_serie, TextView tv_serie_num, LinearLayout ll_serie_live) {
////		CullingTest.IdlistBean.NewslistBean.SpecialDataBean specialData =bean.getSpecialData();
...
//	}
	...
	private void resovleIcon(CullingTest.IdlistBean.NewslistBean bean, ImageView imageView) {
